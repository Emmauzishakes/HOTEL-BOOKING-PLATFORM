  ...
  return (
    <>
      <div>
        ...
        <div className='w-full max-w-3xl text-left mt-3 border border-gray-300 rounded-lg max-h-80 overflow-y-scroll'>
                ...
                <tbody className='text-sm'>
                    {
                        rooms.map((item, index) => (
                            <tr key={index}>
                                ...
                                <td className='py-3 px-4 text-red-500 text-center border-t border-gray-300 text-sm' >
